...
use App\Http\Controllers\Api\Admin\StaffDocumentController;
...
Route::middleware(['auth:sanctum', 'admin.api', 'audit.api'])->prefix('admin')->group(function (): void {
    ...
    Route::delete('/staff-members/{staff_member}/certifications/{certification}', [StaffCertificationController::class, 'destroy'])->middleware('permission.api:staff_members.update,staff_member');
    Route::get('/facilities/{facility}/certification-requirements', [StaffCertificationController::class, 'indexRequirements'])->middleware('permission.api:facilities.read,facility');
    Route::post('/facilities/{facility}/certification-requirements', [StaffCertificationController::class, 'storeRequirement'])->middleware('permission.api:facilities.update,facility');
    Route::put('/facilities/{facility}/certification-requirements/{requirement}', [StaffCertificationController::class, 'updateRequirement'])->middleware('permission.api:facilities.update,facility');
    Route::delete('/facilities/{facility}/certification-requirements/{requirement}', [StaffCertificationController::class, 'destroyRequirement'])->middleware('permission.api:facilities.update,facility');
    Route::get('/facilities/{facility}/certification-compliance', [StaffCertificationController::class, 'compliance'])->middleware('permission.api:staff_members.read,facility');
    ...
    Route::get('/staff-members/{staff_member}/documents', [StaffDocumentController::class, 'index'])->middleware('permission.api:staff_members.read,staff_member');
    Route::post('/staff-members/{staff_member}/documents', [StaffDocumentController::class, 'store'])->middleware('permission.api:attachments.upload,staff_member');
    Route::get('/staff-members/{staff_member}/documents/{document}', [StaffDocumentController::class, 'show'])->middleware('permission.api:staff_members.read,staff_member');
    Route::put('/staff-members/{staff_member}/documents/{document}', [StaffDocumentController::class, 'update'])->middleware('permission.api:staff_members.update,staff_member');
    Route::delete('/staff-members/{staff_member}/documents/{document}', [StaffDocumentController::class, 'destroy'])->middleware('permission.api:staff_members.update,staff_member');
    Route::get('/staff-documents/expiry-summary', [StaffDocumentController::class, 'expirySummary'])->middleware('permission.api:staff_members.read');
    Route::get('/staff-profile-lookups/{lookup}', [StaffProfessionalProfileController::class, 'indexLookup'])->middleware('permission.api:staff_members.read');
    Route::post('/staff-profile-lookups/{lookup}', [StaffProfessionalProfileController::class, 'storeLookup'])->middleware('permission.api:staff_members.create');
    Route::get('/staff-profile-lookups/{lookup}/{item}', [StaffProfessionalProfileController::class, 'showLookup'])->middleware('permission.api:staff_members.read');
    Route::put('/staff-profile-lookups/{lookup}/{item}', [StaffProfessionalProfileController::class, 'updateLookup'])->middleware('permission.api:staff_members.update');
    Route::delete('/staff-profile-lookups/{lookup}/{item}', [StaffProfessionalProfileController::class, 'destroyLookup'])->middleware('permission.api:staff_members.delete');
