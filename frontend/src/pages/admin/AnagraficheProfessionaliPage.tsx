...
import { staffProfessionalProfileApi, apiError } from '../../services/api'
import type { StaffProfileLookupItem } from '../../types'
...
export default function AnagraficheProfessionaliPage() {
  const [activeTab, setActiveTab] = useState<LookupType>('skills')
