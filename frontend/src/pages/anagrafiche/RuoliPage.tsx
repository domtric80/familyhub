              ...
              <>
                ...
                <div className='d-flex gap-3 mb-3'>
                  ...
                  <div className='d-flex align-items-center gap-2'>
                    ...
                    <span className='small text-muted'>Download allegati:</span>
                      ...
                      return (
                        ...
                        <tr key={cls.code} style={{ opacity: cls.is_active ? 1 : 0.5 }}>
                          ...
                          <td>
                            ...
                            {cls.effective_download_access

                              ? cls.requires_minor_assignment

                                ? <span className='badge badge-light-warning' style={{ fontSize: 10 }}>Si (con assegnazione)</span>

                                : <span className='badge badge-light-success' style={{ fontSize: 10 }}>Si</span>
